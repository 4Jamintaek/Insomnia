%% Import data
clear all
load('Ins2Processed.mat', 'NewDataTruncated')
...
%% get FFT
low = [0.5,0.5,8.5,12.5,16];
high = [3.5,14,12,16,30];
bracket = {'FFT', 'delta', 'low', 'alpha', 'sigma', 'beta'};
...
csvwrite('lowmin.csv',bracket{3,3}');
csvwrite('lowmax.csv',bracket{4,3}');
csvwrite('lowmean.csv',bracket{5,3}');
